...
mavenPublishing {
    ...
    pom {
        name = "kpoi-spreadsheet"
        description = "Kotlin DSL for Apache POI spreadsheets (XSSF, SXSSF, HSSF)"
...
dokka {
    moduleName.set("kpoi-spreadsheet")
    dokkaSourceSets.configureEach {
        includes.from("Module.md")
        sourceLink {
            localDirectory.set(file("src/main/kotlin"))
            remoteUrl("https://github.com/KouroshMsv/kpoi/blob/main/kpoi-spreadsheet/src/main/kotlin")
